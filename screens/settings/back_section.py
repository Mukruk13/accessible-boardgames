...
class BackSection(BoxLayout):
    def __init__(self, screen, **kwargs):
        ...
        self.back_button.bind(on_release=lambda instance: self.screen.navigate_to("main_menu"))

        self.add_widget(self.back_button)

    def update_texts(self):
        self.screen.set_text_from_key(self.back_button, "settings.back_to_main_menu")
